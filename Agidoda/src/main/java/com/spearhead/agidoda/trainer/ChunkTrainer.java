...
public class ChunkTrainer {
    ...
    String modelPath = "/train/chunkTrain.txt";

    ChunkerME nameFinder = setupModel();
    private String binFileName="chunk.bin";
    // ChunkerME nameFinder;

    private ChunkerME setupModel() {
        try {
            ...
            try {
                ...
                File modelFile = new File("chunk.bin");
            ...
            nameFinder = new ChunkerME(nameFinderModel);
            return nameFinder;
        } catch (Exception e) {
            e.printStackTrace();
        }
